...
# Add Vercel/Railway domains from environment if specified
...
if custom_domain:
    ...
    cors_origins.append(f"https://www.{custom_domain}")
...
# Configuration
API_KEY = os.getenv('GEMINI_API_KEY', 'AIzaSyCAlLcYZ8hOjPTNjCclyV3t8mW0fgIne0g')
...
If asked about topics unrelated to Anurag University, politely redirect the conversation."""
        ...
        message_content = [{'text': user_message}]
